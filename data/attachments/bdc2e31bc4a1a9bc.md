...
- Name: auth/login.spec.js >> Module 01 – Authentication >> logout works after login
- Location: tests/auth/login.spec.js:56:3
...
Call log:
  ...
  - attempting click action
    ...
    - retrying click action
      - waiting 100ms
    121 × waiting for element to be visible, enabled and stable
        - element is not visible
      - retrying click action
        - waiting 500ms
...
```ts
  ...
  2  |   constructor(page) {
  3  |     this.page          = page;
  4  |     this.usernameInput = page.locator('[data-test="username"]');
  5  |     this.passwordInput = page.locator('[data-test="password"]');
  6  |     this.loginButton   = page.locator('[data-test="login-button"]');
  ...
  19 | 
  20 |   async logout() {
  21 |     await this.page.locator('#react-burger-menu-btn').click();
> 22 |     await this.page.locator('#logout_sidebar_link').click();
     |                                                     ^ Error: locator.click: Test timeout of 60000ms exceeded.
  23 |   }
  24 | }
  25 | 
